...
php ./longeur-cours-eau-france/suivi-cours-eau.php $pg_base_france $fichier_state_base_france > $dossier_cours_eau/comparaison-sandre.html
cp ./longeur-cours-eau-france/sorttable.js $dossier_cours_eau

# Export des régions et départements
./exports-administratif/export-limites-administratives.sh 6 96 departements $chemin_export_administratif $pg_base_france
