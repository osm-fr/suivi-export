...
pgsql2shp -h $2 -p$3 -u $4 -P $5 -f $dossier_temporaire/cours_eau_france $6 "select tags->'ref:sandre' as ref_sandre,name,st_transform(way,4326) as way from planet_osm_line where tags ? 'ref:sandre'  and waterway='river'"
